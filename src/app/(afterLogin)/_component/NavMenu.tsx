          ...
          <div className={style.navPill}>
            {segment === 'home' ? (
              <>
                ...
                <div style={{ fontWeight: 'bold' }}>{STR_MENU.HOME}</div>
              </>
            ) : (
              <>
                <svg
          ...
          <div className={style.navPill}>
            {segment && ['search', 'explore'].includes(segment) ? (
              <>
                ...
                <div style={{ fontWeight: 'bold' }}>{STR_MENU.SEARCH}</div>
              </>
            ) : (
              <>
                <svg
          ...
          <div className={style.navPill}>
            {segment === 'messages' ? (
              <>
                ...
                <div style={{ fontWeight: 'bold' }}>{STR_MENU.MESSAGES}</div>
              </>
            ) : (
              <>
                <svg
            ...
            <div className={style.navPill}>
              {segment === me.id ? (
                <>
                  ...
                  <div style={{ fontWeight: 'bold' }}>{STR_MENU.PROFILE}</div>
                </>
              ) : (
                <>
                  <svg
